...
// não altere!
const servidor = (valoresDht11Umidade, valoresDht11Temperatura) => {
  const app = express();
...
(async () => {
  ...
  await serial(valoresDht11Umidade, valoresDht11Temperatura);
  servidor(valoresDht11Umidade, valoresDht11Temperatura);
})();
